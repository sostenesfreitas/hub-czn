const en = {
  ...
  simulator: {
    ...
    totalDeck: 'Total (raw)',
    totalEffective: 'Total (vs monster)',
    ...
    buffNote: 'Frightened: ×0.75 DMG (cs00_0003) · Exposed: +50%×stacks taken (cs00_0002) · Fortitude: ×0.85 taken (cs00_0062)',
