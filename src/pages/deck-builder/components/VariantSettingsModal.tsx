...
export function VariantSettingsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4">
      <div className="flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-xl border border-[#303044] bg-[#15151f] shadow-2xl">
        <header className="flex shrink-0 items-start justify-between gap-4 border-b border-[#282838] p-4">
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <Sparkles size={17} className="text-[#7dd3fc]" />
            ...
            {!canUseEpiphanies ? (
              ...
              <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 xl:grid-cols-2">
                <section className="flex min-h-0 flex-col rounded-xl border border-[#303044] bg-[#171722] p-3">
                  ...
                  <div className="mt-3 grid min-h-0 flex-1 auto-rows-max grid-cols-1 gap-2 overflow-y-auto pr-1 sm:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
                    {divineEpiphanies.length === 0 ? (
                      <div className="col-span-full flex h-40 items-center justify-center rounded-lg border border-dashed border-[#333348] text-xs text-[#888]">
                        Nenhuma Divine Epiphany encontrada.
                      </div>
                    ) : (
                ...
                <section className="flex min-h-0 flex-col rounded-xl border border-[#303044] bg-[#171722] p-3">
                  ...
                  <div className="mt-3 grid min-h-0 flex-1 auto-rows-max grid-cols-1 gap-2 overflow-y-auto pr-1 sm:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
                    {commonEpiphanies.length === 0 ? (
                      <div className="col-span-full flex h-40 items-center justify-center rounded-lg border border-dashed border-[#333348] text-xs text-[#888]">
                        Nenhuma Spark Epiphany encontrada.
                      </div>
                    ) : (
        ...
        <footer className="flex shrink-0 items-center justify-between gap-3 border-t border-[#282838] p-4">
          <div className="min-w-0 text-[11px] text-[#888]">
            {selectedDivineGod || selectedDivineEpiphany || selectedCommonEpiphany ? (
              <div className="flex min-w-0 flex-wrap gap-x-3 gap-y-1">
                ...
                {selectedDivineEpiphany && (
                  <span className="max-w-[320px] truncate">
                    Divine:{' '}
                    <strong className="text-[#ddd6fe]">
                      {selectedDivineEpiphany.description}
                    </strong>
                  </span>
                )}
              ...
              <span>Nenhuma epifania aplicada.</span>
            )}
          </div>
          ...
          <div className="flex shrink-0 justify-end gap-2">
            <button
              ...
              className="rounded-lg border border-[#333348] px-4 py-2 text-sm font-semibold text-[#fca5a5] hover:border-[#f87171]"
            >
              Limpar
            </button>
            ...
            <button
              type="button"
              onClick={handleApply}
              className="rounded-lg bg-[#2563eb] px-4 py-2 text-sm font-black text-white hover:bg-[#1d4ed8]"
            >
              Aplicar
            </button>
          </div>
